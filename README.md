...
- [Sign Language detector](https://github.com/Omarnab7/sign-language-learning-machine-.git): A learning machine project that detecting in each picture what letter is appearing. 
